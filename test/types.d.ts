...
export declare const enum Corpus {
	UNIVERSAL = 0,
	WEB = 1,
	IMAGES = 2,
	LOCAL = 3,
...
export declare class Fighter_Part1 {
	__class__: string;
	constructor();
	ByteSize(): number;
	Serialize(): Uint8Array;
...
export declare namespace Fighter_Part1 {
	function Deserialize(data: Uint8Array): Fighter_Part1;
}

export declare class Fighter_Part2 {
	__class__: string;
	constructor();
	ByteSize(): number;
	Serialize(): Uint8Array;
...
export declare namespace Fighter_Part2 {
...
export declare namespace Fighter {
