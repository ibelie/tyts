...
function compareFighter_Part1(f1: types.Fighter_Part1, f2: types.Fighter_Part1): void {
	...
	if (f1.Posl.length != f2.Posl.length) {
		...
		for (let k = 0; k < f1.Posl.length; k++) {
